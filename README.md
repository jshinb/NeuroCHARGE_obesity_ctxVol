...
Scripts to run adiposity-ctx structure associations (Please see [PROTOCOL](NeuroCHARGE_Protocol_2025oct.pdf) for details)

Please contact  **Jean Shin** (**[jjshin.research@gmail.com](mailto:jjshin.research@gmail.com)**) for any questions and/or issues.

# Script instructions
1. **Download** the analysis script and all associated files.
2. **Prepare and format** the data files according to the specifications described below.
...
5. **Modify (line 4) and execute** the script **`run_protocols.R`** to generate the analysis outputs.
